...
const validationSchema = Yup.object().shape({
  haveTravel: Yup.boolean().required('Chọn 1 cái đi nào.'),
});
            ...
            <Form className='form mt-5'>
              ...
              <div className='bg-gray-100 grid gap-y-4 p-4 rounded-xl mb-4'>
                <div>
                  ...
                  <RadioGroup>
                    <Radio name='haveTravel' checked={values.haveTravel} id='haveTravel-1' onChange={handleChange} value={true} labelName='Có'/>
                    <Radio name='haveTravel' checked={!values.haveTravel} id='haveTravel-2' onChange={handleChange} value={false} labelName='Không'/>
                  </RadioGroup>
                </div>
                <div>
                  ...
                  <RadioGroup>
                    <Radio name='haveSick' checked={values.haveSick} onChange={handleChange} id='haveSick-1' value={true} labelName='Có'/>
                    <Radio name='haveSick' checked={!values.haveSick} onChange={handleChange} id='haveSick-2' value={false} labelName='Không'/>
                  </RadioGroup>
                </div>
                <div>
